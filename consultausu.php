...
<td aling="center"><a href="javascript:void" onclick="window.location='consultausuid.php?idu=<?php echo $usu[$i]["idu"];?>'"><img src="ima/editar.png" width="16px" height="16px" /></a></td>
<td aling="center"><a href="javascript:void" onclick="window.location='eliminarusuario.php?idu=<?php echo $usu[$i]["idu"];?>'"><img src="ima/eliminar.png" width="16px" height="16px" /></a></td>
</tr>
<?php	
}
?>
