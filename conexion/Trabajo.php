...
public function consulta()
{
	...
	$sql = "SELECT idd,idc,texto1, DATE_FORMAT(fecha1,'%d/%m/%y')as fecha1,texto2,DATE_FORMAT(fecha2, '%d/%m/%y')as fecha2,texto3,DATE_FORMAT(fecha3, '%d/%m/%y')as fecha3,texto4,DATE_FORMAT(fecha4, '%d/%m/%y')as fecha4,imagen1,imagen2,imagen3,fechas,DATE_FORMAT(fechas, '%d/%m/%y')as fechas,usuario FROM descripcion  order by idd asc" ;
	$res=mysql_query($sql,Coneccion::con());
...
public function consultarunning()
{
	/*$sql="select idd,texto,idc,idu from descripcion";*/
	$sql = "SELECT idd,idc,texto1, DATE_FORMAT(fecha1,'%d/%m/%y')as fecha1,texto2,DATE_FORMAT(fecha2, '%d/%m/%y')as fecha2,texto3,DATE_FORMAT(fecha3, '%d/%m/%y')as fecha3,texto4,DATE_FORMAT(fecha4, '%d/%m/%y')as fecha4,imagen1,imagen2,imagen3,fechas,DATE_FORMAT(fechas, '%d/%m/%y')as fechas,usuario FROM descripcion where idc='Running' order by idd desc " ;
	/*order by idd desc*/
	$res=mysql_query($sql,Coneccion::con());
	while($reg=mysql_fetch_assoc($res))
	{
...
public function consultarbiking()
{
	/*$sql="select idd,texto,idc,idu from descripcion";*/
	$sql = "SELECT idd,idc,texto1, DATE_FORMAT(fecha1,'%d/%m/%y')as fecha1,texto2,DATE_FORMAT(fecha2, '%d/%m/%y')as fecha2,texto3,DATE_FORMAT(fecha3, '%d/%m/%y')as fecha3,texto4,DATE_FORMAT(fecha4, '%d/%m/%y')as fecha4,imagen1,imagen2,imagen3,fechas,DATE_FORMAT(fechas, '%d/%m/%y')as fechas,usuario FROM descripcion where idc='Biking' order by idd desc " ;
	/*order by idd desc*/
	$res=mysql_query($sql,Coneccion::con());
	while($reg=mysql_fetch_assoc($res))
	{
...
public function consultarextreme()
{
	/*$sql="select idd,texto,idc,idu from descripcion";*/
	$sql = "SELECT idd,idc,texto1, DATE_FORMAT(fecha1,'%d/%m/%y')as fecha1,texto2,DATE_FORMAT(fecha2, '%d/%m/%y')as fecha2,texto3,DATE_FORMAT(fecha3, '%d/%m/%y')as fecha3,texto4,DATE_FORMAT(fecha4, '%d/%m/%y')as fecha4,imagen1,imagen2,imagen3,fechas,DATE_FORMAT(fechas, '%d/%m/%y')as fechas,usuario FROM descripcion where idc='Extreme' order by idd desc " ;
	/*order by idd desc*/
	$res=mysql_query($sql,Coneccion::con());
	while($reg=mysql_fetch_assoc($res))
	{
...
{
	$sql = "SELECT idd, idc,texto1, DATE_FORMAT(fecha1,'%d/%m/%y')as fecha1,texto2,DATE_FORMAT(fecha2, '%d/%m/%y')as fecha2,texto3,DATE_FORMAT(fecha3, '%d/%m/%y')as fecha3,texto4,DATE_FORMAT(fecha4, '%d/%m/%y')as fecha4,imagen1,imagen2,imagen3,fechas,DATE_FORMAT(fechas, '%d/%m/%y')as fechas,usuario FROM descripcion WHERE idd=$idd ";
	$res=mysql_query($sql,Coneccion::con());
	while($reg=mysql_fetch_assoc($res))
	{
		$this->cons[]=$reg;
